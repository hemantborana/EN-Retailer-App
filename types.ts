...
export const getStyleForColor = (colorName: string): CSSProperties => {
    const colorValue = colorMap[colorName.toUpperCase()];
    if (!colorValue) {
        // Fallback for colors not in the map
