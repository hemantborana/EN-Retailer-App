    ...
    return React.createElement('div', { className: 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 modal-backdrop-enter', onClick: onClose },
        React.createElement('div', { className: 'bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col modal-content-enter', onClick: e => e.stopPropagation() },
            ...
            React.createElement('div', { className: 'flex-grow overflow-y-auto p-4' },
                loading ? React.createElement('p', { className: 'text-gray-900 dark:text-gray-200' }, 'Loading orders...') :
                        ...
                        React.createElement('div', { key: order.id, className: 'border dark:border-gray-700 rounded-lg p-4' },
                            React.createElement('div', { className: 'flex justify-between items-start mb-2' },
                                ...
                                React.createElement('div', { className: 'text-right' },
                                    ...
                                    React.createElement('span', { className: 'px-2 py-1 text-xs font-semibold text-blue-800 bg-blue-100 dark:text-blue-200 dark:bg-blue-900/50 rounded-full' }, order.status)
                                )
                            ),
