...
const inspiringSummaries = [
    "Thank you for your partnership! Your latest selection of premium styles is on its way to delight your customers.",
    "Your order is confirmed! We're proud to partner with you in bringing comfort and confidence to women everywhere.",
    "Order received! We appreciate your business and are already preparing the quality products your customers love.",
    "Thank you for choosing Kambeshwar Agencies. Your order is confirmed, and we're excited to contribute to your success.",
    "Your order is in! Together, we're setting the standard for quality lingerie. Thank you for your continued trust."
];
...
function OrderSuccessModal({ order, onClose }) {
    ...
    const renderSummary = () => {
        return React.createElement('div', {className: 'text-left mt-4'},
             React.createElement('p', { className: 'text-sm text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 p-3 rounded-md' }, randomSummary)
        );
    };
